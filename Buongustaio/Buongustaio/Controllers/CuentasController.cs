...
namespace Buongustaio.Controllers
{
    ...
    public class CuentasController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await SignInManager.PasswordSignInAsync(model.Telefono, model.Password, model.RememberMe, shouldLockout: false);
            switch (result)
            {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model,Clientes cliente,Miembros miembro)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Telefono, Email = model.Email};
                ...
                if (result.Succeeded)
                {
                    ...
                    cliente.Ap_paterno = model.ApellidoPaterno;
                    cliente.Ap_mat = model.ApellidoMaterno;
                    cliente.Telefono = Convert.ToInt64(model.Telefono);
